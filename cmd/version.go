...
var (
	...
	//   -ldflags='-X github.com/previousnext/cloud-ips/cmd.GitVersion=$(git describe --tags --always)'
	GitVersion string
	// GitCommit overridden at build time by:
	//   -ldflags='-X github.com/previousnext/cloud-ips/cmd.GitCommit=$(git rev-list -1 HEAD)'
	GitCommit string
)
